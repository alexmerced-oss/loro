...
def test_machine_readable_support_matrix_has_explicit_stability() -> None:
    ...
    assert matrix["release_line"] == "0.19"
...
def test_release_manifest_hashes_actual_artifacts(tmp_path: Path) -> None:
    ...
    assert manifest["data_support_matrix"]["release_line"] == "0.19"
    assert manifest["interoperability_matrix"]["release_line"] == "0.19"
    assert manifest["release_contract"]["release_line"] == "0.19"
