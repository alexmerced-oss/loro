...
| Scope | Loro CLI 0.2.0 and the first enterprise reference deployment |
...
Current 0.2.0 strengths include bounded agent steps and budgets, typed tools, layered managed configuration,
...
and external release-administration controls remain open. Consequently, Loro 0.2.0 is suitable for
