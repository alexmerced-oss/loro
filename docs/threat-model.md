...
| Scope | Loro CLI 0.15.2 and the stabilization reference deployment |
...
Current 0.15.2 strengths include bounded agent steps and budgets, typed tools, layered managed configuration,
...
and external release-administration controls remain open. Consequently, Loro 0.15.2 is suitable for
