...
| Scope | Loro CLI 0.15.1 and the stabilization reference deployment |
...
Current 0.15.1 strengths include bounded agent steps and budgets, typed tools, layered managed configuration,
...
and external release-administration controls remain open. Consequently, Loro 0.15.1 is suitable for
