...
| Scope | Loro CLI 0.8.0 and the enterprise-beta reference deployment |
...
Current 0.8.0 strengths include bounded agent steps and budgets, typed tools, layered managed configuration,
...
and external release-administration controls remain open. Consequently, Loro 0.8.0 is suitable for
