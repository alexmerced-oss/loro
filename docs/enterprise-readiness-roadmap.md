...
| Permissions | `allow` / `ask` / `deny`, ordered rules, identity-bound interactive approval records | Partial; normalized resource scopes and signed policy versions missing |
