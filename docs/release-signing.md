...
gh attestation verify loro_agent-0.12.0-py3-none-any.whl --repo alexmerced-oss/loro
gh attestation verify loro_agent-0.12.0.tar.gz --repo alexmerced-oss/loro
```
