...
git show --no-patch --format=fuller v0.16.0
```
...
gh attestation verify loro_agent-0.16.0-py3-none-any.whl --repo alexmerced-oss/loro
gh attestation verify loro_agent-0.16.0.tar.gz --repo alexmerced-oss/loro
```
