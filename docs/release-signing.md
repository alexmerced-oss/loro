...
gh attestation verify loro_agent-0.10.0-py3-none-any.whl --repo alexmerced-oss/loro
gh attestation verify loro_agent-0.10.0.tar.gz --repo alexmerced-oss/loro
```
