...
Loro follows semantic-versioning intent while the public surface is pre-1.0. The `0.14`
...
No surface is deprecated in `0.17.0`; the warning type and policy establish the contract for later
releases.
