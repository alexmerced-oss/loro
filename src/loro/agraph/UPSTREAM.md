...
Loro 0.18.0 depends on `agentic-graph-spec>=1.0.1,<2` for canonical JSON, graph digests,
...
pinned 1.0.1 revision. `reference_validator.py` retains only the small token expression and finding/error types from
