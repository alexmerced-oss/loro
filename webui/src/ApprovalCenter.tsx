...
export function ApprovalCenter({ setError }: { setError: (message: string) => void }) {
  ...
  return <div className="modal-backdrop approval-backdrop"><section ref={dialog} tabIndex={-1} className="modal approval-modal" role="alertdialog" aria-modal="true" aria-label="Permission required">
